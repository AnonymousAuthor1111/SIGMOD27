contract BrickBlockToken {
  ...
  CompanyTokensTuple companyTokens;
  ...
  function updateBalancesOnIncrementTotalIn_r51(address p,int i) private    {
      int _delta = int(i);
      uint newValue = updateuintByint(balances[p].n,_delta);
      balances[p].n = newValue;
  }
  ...
  function allowed(address o,address s) private view  returns (uint) {
