contract RepToken {
  ...
  LegacyRepContractTuple legacyRepContract;
  ...
  function updateLegacyRepContractOnInsertConstructor_r29(address l,uint _amountFreeze1,address _freezeAcct2,uint _target3) private    {
      if(l!=address(0)) {
        legacyRepContract = LegacyRepContractTuple(l,true);
      }
  }
  ...
  function updateTotalSupplyOnInsertAllMint_r18(uint n) private    {
