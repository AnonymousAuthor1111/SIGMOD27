contract CrowFunding {
  ...
  function updateRefundTotalOnInsertRefund_r19(address p,uint m) private    {
      int delta1 = int(m);
      updateBalanceOfOnIncrementRefundTotal_r6(p,delta1);
      refundTotal[p].n += m;
  }
  ...
  function updateBalanceOfOnIncrementRefundTotal_r6(address p,int r) private    {
      ...
      updateBalanceOfOnInsertRefundTotal_r6(p,newValue);
  }
  ...
  function updateBalanceOfOnIncrementInvestTotal_r6(address p,int i) private    {
      ...
      updateBalanceOfOnInsertInvestTotal_r6(p,newValue);
  }
  ...
  function updateBalanceOfOnDeleteInvestTotal_r6(address p,uint i) private    {
  ...
  function updateBalanceOfOnInsertRefundTotal_r6(address p,uint r) private    {
      RefundTotalTuple memory toDelete = refundTotal[p];
      if(toDelete._valid==true) {
        updateBalanceOfOnDeleteRefundTotal_r6(p,toDelete.n);
      }
      uint i = investTotal[p].n;
      uint s = i-r;
      balanceOf[p] = BalanceOfTuple(s,true);
  }
  function updateBalanceOfOnInsertInvestTotal_r6(address p,uint i) private    {
      InvestTotalTuple memory toDelete = investTotal[p];
      if(toDelete._valid==true) {
        updateBalanceOfOnDeleteInvestTotal_r6(p,toDelete.n);
      }
      uint r = refundTotal[p].n;
      uint s = i-r;
      balanceOf[p] = BalanceOfTuple(s,true);
  ...
  function updateBalanceOfOnDeleteRefundTotal_r6(address p,uint r) private    {
      uint i = investTotal[p].n;
      uint s = i-r;
      if(s==balanceOf[p].n) {
        balanceOf[p] = BalanceOfTuple(0,false);
